...
export type Result_3 = { Ok: LoginDetails } | { Err: string }
export type Result_4 = { Ok: PrepareLoginDetails } | { Err: string }
...
export interface _SERVICE {
  ...
  siwn_get_delegation: ActorMethod<[string, Uint8Array | number[], bigint], Result_2>
  siwn_login: ActorMethod<[string, string, string, Uint8Array | number[], string], Result_3>
